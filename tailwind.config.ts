  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "neon-pink": "0 0 20px rgba(255, 45, 149, 0.6), 0 0 60px rgba(255, 45, 149, 0.3), 0 0 100px rgba(255, 45, 149, 0.15)",
        "neon-cyan": "0 0 20px rgba(0, 240, 255, 0.6), 0 0 60px rgba(0, 240, 255, 0.3), 0 0 100px rgba(0, 240, 255, 0.15)",
        "neon-green": "0 0 20px rgba(57, 255, 20, 0.6), 0 0 60px rgba(57, 255, 20, 0.3), 0 0 100px rgba(57, 255, 20, 0.15)",
        "neon-purple": "0 0 20px rgba(176, 38, 255, 0.6), 0 0 60px rgba(176, 38, 255, 0.3), 0 0 100px rgba(176, 38, 255, 0.15)",
      },
      animation: {
